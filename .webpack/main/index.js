...
exports.createCANInterface = void 0;
const os = __importStar(__webpack_require__(/*! os */ "os"));
// Calls upon proper CAN Interface depending on OS
function createCANInterface(channelName, win) {
    const platform = os.platform();
    if (platform === 'linux') {
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        const can = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'socketcan'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
exports.createCANInterface = createCANInterface;
// Linux-specific CAN Implementation
class LinuxCANInterface {
    constructor(can, channelName) {
        this.can = can;
    ...
    start() {
        ...
        this.channel.addListener('onMessage', (msg) => {
            ...
            console.log(`CAN Message: ID=0x${msg.id.toString(16)}, Data=${msg.data.toString('hex')}`);
        });
    }
    stop() {
        this.channel.stop();
...
const can_interface_1 = __webpack_require__(/*! ./CAN/can_interface */ "./src/CAN/can_interface.ts");
let canInterface = null;
...
const createWindow = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const mainWindow = new electron_1.BrowserWindow({
        ...
        width: 800,
        webPreferences: {
            preload: '/Users/anish/Documents/LHR_24-25/BEVO_Software/BEVO-2025/.webpack/renderer/main_window/preload.js',
        },
    });
    ...
    try {
        canInterface = yield (0, can_interface_1.createCANInterface)("vcan0", mainWindow);
        canInterface.start();
    }
    catch (error) {
        console.error("Error initializing CAN interface:", error);
    }
    electron_1.ipcMain.on('can-message', (event, title) => {
        console.log('Received can-message event');
        console.log('Title received:', title); // Logs the 'title' argument
    });
});
